      ...
      <Card.Title>Edit User</Card.Title>
        <Form onSubmit={handleSubmit}>
          ...
          <Form.Group className="mb-3" controlId="formBasicCreatedOn">
            ...
            <Form.Control value={form.CreatedOn} type="date" placeholder="Enter CreatedOn" size="sm" onChange={handleInputCreatedOnChange} />
          </Form.Group>

          <Form.Group className="mb-3" controlId="formBasicLastLogin">
            <Form.Label>LastLogin</Form.Label>
            <Form.Control value={form.lastLogin} type="timestamp" placeholder="Enter LastLogin"size="sm" onChange={handleInputLastLoginChange} />
          </Form.Group>
